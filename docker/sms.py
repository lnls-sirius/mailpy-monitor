...
To do:
    - implement log
        - log when can't connect to PV (and exclude from main loop?)
        - log when an e-mail is sent
        - log when can't log in (password wrong)
    ...
    - in decreasing step: support when hop is higher than one step
    ...
    <html>
        <body>
            <p>""" + warning + """<br>
                ...
                Archiver link: <a href="https://10.0.6.57">https://10.0.6.57<a><br><br>
                Controls Group
            </p>
        </body>
    </html>
